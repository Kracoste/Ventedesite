export const companyInfo = {
  ...
  values: [
    "Performance et accessibilité au cœur de chaque projet",
...
export const stats = [
  { value: "+1", label: "Projets livrés" },
  { value: "1 an", label: "d'expérience cumulée" },
  { value: "4,9/5", label: "Satisfaction moyenne" },
  { value: "< 2 s", label: "Temps de chargement moyen" },
];
